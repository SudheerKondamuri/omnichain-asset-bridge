...
export function checkIfProcessed(nonce: number, chainId: number, eventType: string): boolean {
...
export function markAsProcessed(nonce: number, chainId: number, eventType: string, txHash: string): void {
    db.prepare(
...
export function checkIfProposalProcessed(proposalId: number, chainId: number): boolean {
    const row = db.prepare(
...
export function markProposalAsProcessed(proposalId: number, chainId: number, txHash: string): void {
    db.prepare(
